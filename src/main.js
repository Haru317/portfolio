...
const copy = {
  ...
  ja: {
    ...
    practice: {
      label: "実践方法",
      lead: "最も価値あるものは、まだ名前を持たないところから始まります。直感、関係性、文化資産、そして断片的な事実の間に潜むパターン。",
      follow: "私はその価値に所在を与え、社会で機能するためのフレームワーク、プロダクト、組織へと設計します。",
      methods: [
        ["見出す", "見えない資本を可視化し、判断の基準となる事実を確立する。"],
    ...
    work: {
      label: "選定プロジェクト",
      title: "アイデアを、機能する仕組みへ。",
      intro: "フレームワーク、事業、文化実験からなる実装の記録です。共通する問いはひとつ——見えない価値を、どう持続する価値へ変えるか。",
      note: "このほか、キャリア設計、トラウマ統合、倫理教育、視覚戦略、文化的ペアリング、社会基盤、外交的バイオグラフィーまで扱っています。",
      open: "開く"
    },
    principles: {
      label: "紋章と中核原則",
      lines: ["再生には秩序がいる。", "秩序には信頼がいる。", "信頼は共同体になる。"],
      rows: [
        ["Delta", "再生のための革新"],
        ["Lambda", "信頼と継続のための秩序"],
        ["Circle", "相互繁栄のための共同体"]
    ...
    lineage: {
      label: "系譜と実践",
      quote: ["「人が感じながら、まだ名づけられないものを、", "私は設計する。」"],
      bio: "地域を担う武家、国学者、芸術家を輩出してきた家系と、1,300年続く生きた伝統の中に生まれました。そこでは、同じ灯火が千年以上守られてきました。私は自由で天真爛漫な気質を持ちながら、責任、節度、他者への配慮が静かに絶対視される環境で育ちました。その緊張が、意思決定・制度・文化の下に流れる人間の力学を読む感覚を磨きました。いま、その感覚は、見えない資本を見出し、測定可能なインパクトへ変える仕事の基盤になっています。",
      credentials: [
    ...
    <main id="top">
      <section class="hero">
        ...
        <div class="hero-portrait reveal">
          <img src="/haruno-profile.jpeg" alt="Haruno Ayukai" onerror="this.style.display='none'">
