...
const copy = {
  ...
  ja: {
    ...
    hero: [
      "曖昧なアイデアを価値創造可能な構造へと翻訳する。"
    ],
    heroBody: [
      "人の行動、文化、組織、市場に散在する見過ごされた兆候や共通パターンをつなぎ、社会が意味を理解し、価値を評価・検証・創造するためのフレームワーク、ツール、構想として可視化します。"
    ],
    selected: "プロジェクトを見る",
    portrait: "リサーチ · 戦略 · デザイン",
    practice: {
      label: "仕事の進め方",
      lead: "私の仕事は、まだ明確に定義されていない物事の、繰り返し現れる違和感、見過ごされた可能性、既存のものさしでは説明できない現象から始まります。",
      follow: "そういった曖昧なコンセプトを、多様な分野の事例や構造と照合し、背景にある共通原理を特定して、他者が理解し、検討し、試し、さらに発展させられる形へ変換します。",
      methods: [
