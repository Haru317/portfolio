...
const copy = {
  ...
  ja: {
    ...
    hero: "曖昧なアイデアを価値創造可能な構造へと翻訳する。",
    heroBody: "人の行動、文化、組織、市場に散在する見過ごされた兆候や共通パターンをつなぎ、社会が意味を理解し、価値を評価・検証・創造するためのフレームワーク、ツール、構想として可視化します。",
    selected: "プロジェクトを見る",
    portrait: "リサーチ · 戦略 · デザイン",
    practice: {
      label: "仕事の進め方",
      lead: "私の仕事は、まだ明確に定義されていない物事に潜む違和感や、見過ごされている可能性、既存のものさしでは捉えきれない現象を見いだすことから始まります。",
      follow: "それらを分野を越えた事例や構造と照らし合わせ、背景にある共通原理を明らかにし、他者が理解し、検討し、試し、さらに発展させられる形へ変換します。",
      methods: [
        ["観察する", "見過ごされている兆候、当事者の感覚、背景となる事実を集める。"],
        ["接続する", "人の行動、文化、組織、市場など、分野を越えて現れる類似パターン構造を照合する。"],
        ["明確にする", "背景にある構造を抽出し、その意味、前提、影響を大衆が認識できる形に翻訳する。"],
        ["形にする", "そうして得られた理解を、フレームワーク、診断、学習体験、物語、デジタルツールとして実装し、改善可能にする。"]
      ]
    },
    work: {
      label: "主なプロジェクト",
      ...
      note: "扱う領域は異なりますが、共通する機能は一つです。既存の分類では取りこぼされるものを特定し、人が理解し、より良く判断し、そこから意味ある価値を生み出すための道具を設計します。",
      open: "開く"
    },
    principles: {
      label: "紋章と中核原則",
    ...
    lineage: {
      label: "系譜と実践",
      quote: ["「人が感じ取りながらも名前を付けられない概念を、可視化し翻訳し設計する。」"],
      bio: "数世紀にわたり地域の文化継承を担う武家、国学者、芸術家を輩出してきた家系に生まれ、1,300年続く生きた伝統の中で育ちました。そこでは、千年以上守られた灯火と概念の継承を絶やさないことが義務でした。私は自由で天真爛漫な気質を持って生まれながら、責任・節度・他者への配慮が絶対視される環境で育ちました。その緊張が、意思決定・制度・文化の下に流れる、見えない人間の力学を読む感覚を磨きました。その感覚は今、見えない資本を見出し、測定可能なインパクトへ変える私の基盤となっています。",
      credentials: [
        ["実践領域", "見えない資本の設計者", "見えない価値を、測定可能なインパクトへ変える"],
        ["創設者", "Human Connection Ecosystem", ""],
        ["国際舞台", "Miss Globe Japan ’18", ""],
        ["系譜", "1,300年の伝統に連なる<br>630年の学術的継承", ""]
      ]
    },
    contact: {
      label: "協働",
      title: ["世界がまだ明確に捉えられていない価値をお持ちですか？"]
    }
  }
};
